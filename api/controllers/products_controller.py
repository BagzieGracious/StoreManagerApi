...
class ProductsController(MethodView):
    ...
    def get(product_id=None):
        ...
        if product_id is None:
            return jsonify(ProductModel.get_products_data()), 200
    ...
    def post():
        ...
        post_values = DataValidation.validate_product(post_data['quantity'], post_data['minQuantity'], post_data['product'], post_data['description'], post_data['productDateAdded'])
        ...
        if isinstance(post_values, bool):
            data_object = {
                ...
                "productDateAdded": post_data['productDateAdded'],
            }
